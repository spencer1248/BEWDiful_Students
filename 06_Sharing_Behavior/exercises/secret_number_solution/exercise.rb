...
#
# Main/Runner
#   The main class is where the game begins. The Game object should be instantiated here.
#
# SecretNumber
#   This class should handle creating and managing the secret number.
#
# Player
#  Should initialize the with the player's name and handle player responsibilities.
#
# Game
...
#       Start with empty classes and start coding from the main class.